...
import 'package:halftimepick/models/news_nba/news.dart';
...
class NbaImageTile extends StatefulWidget {
  const NbaImageTile(
      {Key? key,
      required this.index,
      required this.width,
  ...
  final int width;
  final int height;
  final RxList<News> list;
  final String ratio;

  @override
  State<NbaImageTile> createState() => _NbaImageTileState();
}

class _NbaImageTileState extends State<NbaImageTile> {
